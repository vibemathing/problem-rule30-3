...
```json
{
  ...
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "rule30-3",
        "url": "https://www.rule30prize.org/"
      },
      {
        "retrieved_at": "2026-09-08T08:24:29Z",
    ...
    "statement": {
      "language": "en",
      "text": "Draft bounty intake target(s): Rule30计算不可约性. The exact mathematical statement, quantifiers, definitions, assumptions, and acceptance conditions have not yet been frozen; this draft is not research-admitted.",
      "version": 1
    },
    "title": "Rule30计算不可约性",
    "updated_at": "2026-09-08T08:24:29Z"
  },
  "problem_contract_sha256": "8f76eb70db6bf8fc1be7e51fde1ca34739dd76c9c06d784280af608f8d9216a4"
}
```
